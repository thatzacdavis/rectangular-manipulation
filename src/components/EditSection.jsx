...
export const EditSection = ({ selectedId, setSelectedId, rectangles, setRectangles, newColor, setNewColor }) => {
    return (
        <>
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={() => setRectangles([])}>Clear</button>
            <div className="w-full max-w-md">
                ...
                {!selectedId
                    ...
                    : (<div key={selectedId}>
                        ...
                        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-2" onClick={() => {
